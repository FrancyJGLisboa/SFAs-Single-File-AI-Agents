...
"""
Climate Test Single File Agent

Example Usage:
    uv run climate_test.py -d <data_path> -p "your analysis request" -c 5
"""
...
def pre_execution_validation(data: Dict, reasoning: str) -> bool:
    ...
    try:
        ...
        with MemoryManager() as mm:
            for check in ['data_quality_checks', 'approach_validation', 'expected_outcome_definition']:
...
def during_execution_validation(data: Dict, reasoning: str) -> bool:
    ...
    try:
        ...
        with MemoryManager() as mm:
            for check in ['test_on_subset', 'verify_intermediate_results', 'physical_bounds_check']:
                if not globals()[f"validate_{check}"](data, f"Running {check}"):
                    return False
            return True
    except Exception as e:
...
def post_execution_validation(data: Dict, reasoning: str) -> bool:
    ...
    try:
        ...
        with MemoryManager() as mm:
            for check in ['results_verification', 'confidence_assessment', 'domain_knowledge_validation']:
                if not globals()[f"validate_{check}"](data, f"Running {check}"):
                    return False
            return True
    except Exception as e:
...
def validate_data_integrity(reasoning: str, {{params}}) -> str:
    """{{description}}
    ...
    try:
        ...
        console.log(f"[blue]Strict Validation[/blue] - validate_data_integrity - Reasoning: {reasoning}")
        return result
    except ValidationError as e:
        console.log(f"[red]Schema validation failed: {str(e)}[/red]")
        return str(e)
    
def analyze_temperature_trends(reasoning: str, {{params}}) -> str:
    """{{description}}
    Implements strict validation with schema enforcement.
    """
    try:
        ...
        console.log(f"[blue]Strict Validation[/blue] - analyze_temperature_trends - Reasoning: {reasoning}")
        return result
    except ValidationError as e:
        console.log(f"[red]Schema validation failed: {str(e)}[/red]")
        return str(e)
    
def analyze_precipitation(reasoning: str, {{params}}) -> str:
    """{{description}}
    Implements strict validation with schema enforcement.
    """
    try:
        ...
        console.log(f"[blue]Strict Validation[/blue] - analyze_precipitation - Reasoning: {reasoning}")
        return result
    except ValidationError as e:
        console.log(f"[red]Schema validation failed: {str(e)}[/red]")
        return str(e)
    
def verify_results(reasoning: str, {{params}}) -> str:
    """{{description}}
    Implements strict validation with schema enforcement.
    """
    try:
        ...
        console.log(f"[blue]Strict Validation[/blue] - verify_results - Reasoning: {reasoning}")
        return result
    except ValidationError as e:
        console.log(f"[red]Schema validation failed: {str(e)}[/red]")
        return str(e)
...
# Main execution
def main():
    parser = argparse.ArgumentParser(description="Climate Test")
