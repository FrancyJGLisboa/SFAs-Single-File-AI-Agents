...
"""
Duckdb Test Single File Agent

Example Usage:
    uv run duckdb_test.py -d <data_path> -p "your analysis request" -c 5
"""
...
def pre_execution_validation(data: Dict, reasoning: str) -> bool:
    ...
    try:
        ...
        with MemoryManager() as mm:
            for check in ['query_validation', 'schema_verification', 'cost_estimation']:
...
def during_execution_validation(data: Dict, reasoning: str) -> bool:
    ...
    try:
        ...
        with MemoryManager() as mm:
            for check in ['test_on_subset', 'performance_monitoring', 'result_sampling']:
                if not globals()[f"validate_{check}"](data, f"Running {check}"):
                    return False
            return True
    except Exception as e:
...
def post_execution_validation(data: Dict, reasoning: str) -> bool:
    ...
    try:
        ...
        with MemoryManager() as mm:
            for check in ['result_verification', 'data_quality_check', 'consistency_validation']:
                if not globals()[f"validate_{check}"](data, f"Running {check}"):
                    return False
            return True
    except Exception as e:
...
def list_tables(reasoning: str, {{params}}) -> str:
    """{{description}}
    ...
    try:
        ...
        console.log(f"[blue]Strict Validation[/blue] - list_tables - Reasoning: {reasoning}")
        return result
    except ValidationError as e:
        console.log(f"[red]Schema validation failed: {str(e)}[/red]")
        return str(e)
    
def describe_table(reasoning: str, {{params}}) -> str:
    """{{description}}
    Implements strict validation with schema enforcement.
    """
    try:
        ...
        console.log(f"[blue]Strict Validation[/blue] - describe_table - Reasoning: {reasoning}")
        return result
    except ValidationError as e:
        console.log(f"[red]Schema validation failed: {str(e)}[/red]")
        return str(e)
    
def sample_table(reasoning: str, {{params}}) -> str:
    """{{description}}
    Implements strict validation with schema enforcement.
    """
    try:
        ...
        console.log(f"[blue]Strict Validation[/blue] - sample_table - Reasoning: {reasoning}")
        return result
    except ValidationError as e:
        console.log(f"[red]Schema validation failed: {str(e)}[/red]")
        return str(e)
    
def run_test_query(reasoning: str, {{params}}) -> str:
    """{{description}}
    Implements strict validation with schema enforcement.
    """
    try:
        ...
        console.log(f"[blue]Strict Validation[/blue] - run_test_query - Reasoning: {reasoning}")
        return result
    except ValidationError as e:
        console.log(f"[red]Schema validation failed: {str(e)}[/red]")
        return str(e)
    
def run_final_query(reasoning: str, {{params}}) -> str:
    """{{description}}
    Implements strict validation with schema enforcement.
    """
    try:
        ...
        console.log(f"[blue]Strict Validation[/blue] - run_final_query - Reasoning: {reasoning}")
        return result
    except ValidationError as e:
        console.log(f"[red]Schema validation failed: {str(e)}[/red]")
        return str(e)
...
# Main execution
def main():
    parser = argparse.ArgumentParser(description="Duckdb Test")
